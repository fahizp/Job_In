            ...
            <div className='col-md-6 col-12'>
              <div className='d-flex'>
                ...
                <div className='flex-1'>
                  <h5 className='mt-0'>
                    How our <span className='text-primary'>job_in</span> work ?
                  </h5>
            ...
            <div className='col-md-6 col-12 mt-4 pt-2'>
              <div className='d-flex'>
                ...
                <div className='flex-1'>
                  <h5 className='mt-0'>
                    {' '}
                    Is <span className='text-primary'>job_in</span> safer to use
                    with my account ?
                  </h5>
                  <p className='answer text-muted mb-0'>
            ...
            <div className='col-12 text-center'>
              <div className='section-title'>
                ...
                <p className='text-muted para-desc mx-auto'>
                  Start working with{' '}
                  <span className='text-primary fw-bold'>job_in</span> that can
