          ...
          <div className='row g-4'>
            <div className='col-lg-8 col-md-7 col-12'>
              ...
              <p className='text-muted'>
                Obviously, I am a Web Developer with over 3 years of experience.
                Experienced with all stages of the development cycle for dynamic
                web projects. The as opposed to using 'Content here, content
                here', making it look like readable English.
              </p>
              <p className='text-muted'>
                Data Structures and Algorithms are the heart of programming.
                Initially, most developers do not realize their importance, but
                when you start your career in software development, you will
            ...
            <div className='col-lg-4 col-md-5 col-12'>
              <div className='card bg-light p-4 rounded shadow'>
                ...
                <a
                  href={pdf}
                  className='btn btn-soft-primary btn-icon btn-pill mb-4'
                  download
                >
