          ...
          <div className='position-middle-bottom'>
            <nav aria-label='breadcrumb' className='d-block'>
              <ul className='breadcrumb breadcrumb-muted mb-0 p-0'>
                ...
                <li className='breadcrumb-item'>
                  <Link to='/helpcenter-overview'>Help Center</Link>
                </li>
                    ...
                    return (
                      <div className='accordion-item rounded mt-2' key={index}>
                        <h2 className='accordion-header' id='headingOne'>
                          <button
                            className={`${activeIndex1 === index ? '' : 'collapsed'} accordion-button border-0 bg-light`}
                        ...
                        <div
                          id='collapseOne'
                          className={`${activeIndex1 === index ? 'show' : ''} accordion-collapse border-0 collapse`}
                        >
                  ...
                  {accordionData.map((item, index) => {
                    return (
                      <div className='accordion-item rounded mt-2' key={index}>
                        <h2 className='accordion-header' id='headingOne'>
                          <button
                            className={`${activeIndex2 === index ? '' : 'collapsed'} accordion-button border-0 bg-light`}
                        ...
                        <div
                          id='collapseOne'
                          className={`${activeIndex2 === index ? 'show' : ''} accordion-collapse border-0 collapse`}
                        >
                          <div className='accordion-body text-muted'>
                            There are many variations of passages of Lorem Ipsum
                            available, but the majority have suffered alteration
                  ...
                  {accordionData.map((item, index) => {
                    return (
                      <div className='accordion-item rounded mt-2' key={index}>
                        <h2 className='accordion-header' id='headingOne'>
                          <button
                            className={`${activeIndex3 === index ? '' : 'collapsed'} accordion-button border-0 bg-light`}
                        ...
                        <div
                          id='collapseOne'
                          className={`${activeIndex3 === index ? 'show' : ''} accordion-collapse border-0 collapse`}
                        >
                          <div className='accordion-body text-muted'>
                            There are many variations of passages of Lorem Ipsum
                            available, but the majority have suffered alteration
                  ...
                  {accordionData.map((item, index) => {
                    return (
                      <div className='accordion-item rounded mt-2' key={index}>
                        <h2 className='accordion-header' id='headingOne'>
                          <button
                            className={`${activeIndex4 === index ? '' : 'collapsed'} accordion-button border-0 bg-light`}
                        ...
                        <div
                          id='collapseOne'
                          className={`${activeIndex4 === index ? 'show' : ''} accordion-collapse border-0 collapse`}
                        >
                          <div className='accordion-body text-muted'>
                            There are many variations of passages of Lorem Ipsum
                            available, but the majority have suffered alteration
