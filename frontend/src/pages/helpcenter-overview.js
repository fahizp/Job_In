            ...
            <div className='col-12'>
              <div className='section-title text-center mb-4 pb-2'>
                ...
                <p className='para-desc mx-auto text-muted'>
                  ...
                  artists of all job_in with their fans and unique token
                  collectors!
                </p>
              </div>
            </div>
                  ...
                  return (
                    <div className='accordion-item rounded mt-2' key={index}>
                      <h2 className='accordion-header' id='headingOne'>
                        <button
                          className={`${activeIndex === index ? '' : 'collapsed'} accordion-button border-0 bg-light`}
                      ...
                      <div
                        id='collapseOne'
                        className={`${activeIndex === index ? 'show' : ''} accordion-collapse border-0 collapse`}
                      >
