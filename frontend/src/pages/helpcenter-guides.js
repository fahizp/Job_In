                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 col-md-6 col-12 mt-4 mt-lg-0 pt-2 pt-lg-0 pt-2">
                        ...
                        <ul className="list-unstyled mt-4 mb-0">
                            ...
                            <li className="mt-2"><Link to="#" className="text-muted"><i className="mdi mdi-arrow-right text-primary me-2"></i>job_in Plus</Link></li>
                    ...
                    <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        ...
                        <ul className="list-unstyled mt-4 mb-0">
                            <li className="mt-2"><Link to="#" className="text-muted"><i className="mdi mdi-arrow-right text-primary me-2"></i>job_in safely</Link></li>
                            <li className="mt-2"><Link to="#" className="text-muted"><i className="mdi mdi-arrow-right text-primary me-2"></i>job_in Experiences and Adventures</Link></li>
